...
// Matches backend StudentInformationResponse returned by /api/dashboard/student/info.
export const StudentInfoResponseZod = z.object({
...
export type StudentInfo = z.infer<typeof StudentInfoResponseZod>;
