...
@Table(
    ...
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uk_student_enrollments_student_course_semester",
...
public class StudentEnrollment {
    ...
    @Convert(converter = StudentEnrollmentStatus.StudentEnrollmentStatusConverter.class)
    ...
    public void setStatus(StudentEnrollmentStatus status) {
        this.status = status;
    }
